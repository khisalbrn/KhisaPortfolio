...
const sampleProjects = [
  ...
  },
  {
    ...
    status: 'In Progress',
    description: "This project focuses on the development of a landmine detection drone designed specifically to assist farmers in post-conflict regions whose fields remain contaminated with anti-personnel landmines. The goal is to provide a low-cost, rugged, and autonomous aerial solution that can safely scan agricultural land and identify buried threats, enabling farmers to reclaim and cultivate their land without fear. The drone utilizes inductive sensing technology capable of detecting both military-grade and improvised explosive devices hidden below the surface. Unlike traditional drones, this platform is intended to be powered by a diesel or gasoline engine to provide longer flight endurance and to ensure functionality in remote areas where electric recharging infrastructure is unavailable. Due to the lack of GPS integration, the drone is being designed to map its environment autonomously using onboard sensors and pathfinding algorithms. The overall system prioritizes reliability, field-repairability, and minimal user intervention. Although the feature set is still being actively developed, the project represents a step toward scalable humanitarian drone applications that directly support agricultural restoration and economic recovery in mine-affected areas.",
    thumbnail: UXO,
    report:{},
